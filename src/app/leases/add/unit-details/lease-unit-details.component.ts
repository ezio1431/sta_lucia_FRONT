...
@Component({
    ...
    templateUrl: './lease-unit-details.component.html',
    styleUrls: ['./lease-unit-details.component.scss']
})
export class LeaseUnitDetailsComponent implements OnInit, AfterViewInit  {
  ...
  //  amenities: any;
    ...
    constructor(@Inject(MAT_DIALOG_DATA) row: any,
                ...
                private memberService: LeaseService,
                private landlordEntityService: LeaseService,
                private notification: LeaseService,
                private dialogRef: MatDialogRef<LeaseUnitDetailsComponent>) {
