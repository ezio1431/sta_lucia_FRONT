...
@Component({
    ...
    templateUrl: './tenant-unit-details.component.html',
    styleUrls: ['./tenant-unit-details.component.scss']
})
export class TenantUnitDetailsComponent implements OnInit, AfterViewInit  {
  ...
  //  amenities: any;
    ...
    constructor(@Inject(MAT_DIALOG_DATA) row: any,
                ...
                private landlordEntityService: TenantService,
                private notification: TenantService,
                private dialogRef: MatDialogRef<TenantUnitDetailsComponent>) {
