...
import { UtilityBillDataSource } from './data/utility-bill-data.source';
...
export class UtilityBillComponent implements OnInit, AfterViewInit {
   ...
   // utilities$: Observable<UtilityModel>;
     ...
     * @param property
     */
    onSelected(property: UtilityBillModel): void {
...
/*    ngAfterViewInit() {
     ...
     * Add dialog launch
     */
    addDialog(mode: string, landlord?: UtilityBillModel) {
   ...
   /* loadData() {
     ...
     * @param landlord
     */
    openConfirmationDialog(landlord: UtilityBillModel) {
     ...
     * @param landlord
     */
   delete(landlord: UtilityBillModel) {
       // this.loader = true;
