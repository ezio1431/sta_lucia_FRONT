...
@Component({
    ...
    templateUrl: './view-utility-bill-general.component.html',
    styleUrls: ['./view-utility-bill-general.component.css']
})
export class ViewUtilityBillGeneralComponent implements OnInit {
    ...
    constructor(private propertyEntityService: UtilityBillEntityService, private notification: NotificationService) {}
