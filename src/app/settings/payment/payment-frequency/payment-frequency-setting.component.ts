...
@Component({
    ...
    styleUrls: ['./payment-frequency-setting.component.scss']
})
export class PaymentFrequencySettingComponent implements OnInit, AfterViewInit {
    ...
    constructor(private paymentFrequencyEntityService: PaymentFrequencyEntityService, private notification: NotificationService,
    ...
    ngOnInit() {
        ...
        this.dataSource$ = this.paymentFrequencyEntityService.entities$;

        /*this.paymentFrequencyEntityService.selectors$.collection$.subscribe(xxx => {
            this.meta = xxx;
        });
    ...
    loadPaymentMethods() {
        this.paymentFrequencyEntityService.loaded$
            ...
            this.utilities$ = this.paymentFrequencyEntityService.entities$;
        });
    }
     ...
     * Add dialog launch
     */
    addDialog(mode: string, paymentFrequency?: PaymentFrequencyModel) {
        const dialogConfig = new MatDialogConfig();
        dialogConfig.disableClose = true;
        dialogConfig.autoFocus = true;

        dialogConfig.data = {paymentFrequency,
            mode: mode
        };
     ...
     */
    openConfirmationDialog(paymentFrequency: PaymentFrequencyModel) {
     ...
     * @param paymentFrequency
     */
    delete(paymentFrequency: PaymentFrequencyModel) {
    }
